...
def readData(dataset, data_path='./data'):
    ...
    # print(sio.loadmat(os.path.join(data_path, X_1)))
    # print(sio.loadmat(os.path.join(data_path, y_1)))
...
def get_targets(name):
    targets_dict = {
        ...
        'DF': ['Unclassified','Healthy grass', 'Stressed grass', 'Artificial turf', 'Evergreen trees', 'Deciduous trees', 'Bare Earth', 'Water', 
