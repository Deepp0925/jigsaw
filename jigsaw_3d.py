...
def splitTrainTestSet(X, y, testRatio, random_state=345):
    # NOTE: removed 'stratify=y' from 'train_test_split' function (last argument)
...
# NOTE: changed '0.7' (3rd argument) to 'test_ratio'
Xvalidate, Xtest, yvalidate, ytest = splitTrainTestSet(Xtest, ytest, test_ratio, random_state=None)
...
print(f'np argmax: {np.argmax(Ytest, axis=1)}')
